 ...
 */
class ExtraParamsCache extends \common\components\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return new \common\models\Queries\ExtraParamsCache(get_called_class());
    }
...
//            $selected = array_map('intval', $selected);
        ...
        $lang = (int)\common\models\Lang::getCurrentId();
