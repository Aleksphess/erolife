...
class SLinkPager extends \yii\widgets\LinkPager
{
    ...
    public $prevPageLabel      = '<img width="45" src="/images/left-arrow-pag.svg">';
    public $nextPageLabel      = '<img width="45" src="/images/right-arrow-pag.svg">';
    public $firstPageLabel     = false;
    public $lastPageLabel      = false;
    public $activePageCssClass = "active";
    public $firstPageCssClass  = 'list_link';
    public $prevPageCssClass   = 'prev-page ';
